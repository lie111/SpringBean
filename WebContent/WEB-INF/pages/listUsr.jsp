...
<body>
	<h1 style="text-align:center">Use Simple controller</h1>
...
<table border="1" width="100%">
	...
	<tr>
	   ...
	   <td><img style="min-width:50px; max-height:50px;" src="${pageContext.request.contextPath}/userImages/${row.img}" alt="No imgae"/></td>   
